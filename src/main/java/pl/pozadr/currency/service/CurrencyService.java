...
public class CurrencyService {
    private CurrencyLive currencyLive;
    ...
    public CurrencyService() {
        ...
        this.currencyLive = restTemplateCity.getForObject(
    ...
    public void getRandomToPlnRate(Currency random) {
        Double randomRate = currencyMap.get(random);
        Double plnRate = currencyMap.get(Currency.PLN);

        System.out.println("PLN: " + plnRate);
        System.out.println(random.toString() + ": " + randomRate);

        try {
            Double plnToRandom = plnRate / randomRate;
            System.out.println(plnToRandom);
    ...
    public CurrencyLive getCurrencyLive() {
        return currencyLive;
    }


    public void setCurrencyLive(CurrencyLive currencyLive) {
        this.currencyLive = currencyLive;
    }
